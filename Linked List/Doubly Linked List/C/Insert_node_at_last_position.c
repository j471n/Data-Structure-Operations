/*
 *  Objective  : This Program is to Insert a node at last position in Doubly Linked List.
...
int main()
{
    ...
    createLinkedList(n);
    int element;
    printf("Enter the Data to Insert at Last Position : ");
    scanf("%d", &element);

    lastInsert(element);   // Calling insert Function with element argument
